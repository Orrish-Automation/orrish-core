...
public class PlaywrightIntegrationTest {
    ...
    public void anotherTest() {
        ...
        assertTrue(playwrightAppiumSteps.clickWithPartialText("Inputs"));
        ...
        assertTrue(playwrightAppiumSteps.clickNumber("input", "1"));
        assertTrue(playwrightAppiumSteps.clearText());
        assertTrue(playwrightAppiumSteps.getFullTextFor("input").equals(""));
        assertTrue(playwrightAppiumSteps.typeInNumber("456", "1"));
        ...
        //assertTrue(playwrightAppiumSteps.typeWithPartialText("hello", "Your content goes here."));
        assertTrue(playwrightAppiumSteps.inBrowserNavigateTo("https://the-internet.herokuapp.com/disappearing_elements"));
        assertTrue(playwrightAppiumSteps.clickToTheOf("Powered by", "below", "Home"));
        assertTrue(playwrightAppiumSteps.inBrowserNavigateTo("https://the-internet.herokuapp.com"));
        ...
        assertTrue(playwrightAppiumSteps.waitUntilContains("//a[contains(text(), 'Inputs')]", "Inputs"));
        assertTrue(playwrightAppiumSteps.waitUntilDoesNotContain("//a[contains(text(), 'Inputs')]", "Hello"));
        ...
        assertTrue(playwrightAppiumSteps.waitUntilOneOfIsEnabled("//a[contains(text(), 'Checkboxes')]"));
        ...
        playwrightAppiumSteps.click("Upload");
